...
const NavbarWithSubmenu = () => {
  ...
  return (
    <div className="">
      <RightDrawer DrawerOpen={open} onClose={closeDrawer} />
      <Navbar className=" mb-6 px-4 py-2 lg:px-8 lg:py-4 ">
        <div className="container mx-auto flex flex-col items-center text-blue-gray-900">
          <div className="flex w-full top-container">
            <div className="">
              <IconButton
                variant="text"
                className="lg:hidden"
